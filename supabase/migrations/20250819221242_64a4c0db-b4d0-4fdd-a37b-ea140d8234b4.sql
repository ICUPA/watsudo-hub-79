...
-- Helper function for nearby drivers (fixed round function)
...
returns table (
  ...
  select
    ...
    cast(ST_DistanceSphere(d.geom::geometry, ST_MakePoint(lon, lat)) / 1000.0 as numeric(10,2)) as distance_km,
