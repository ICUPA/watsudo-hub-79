...
const PHONE_ID = Deno.env.get("WHATSAPP_PHONE_NUMBER_ID") || Deno.env.get("META_PHONE_NUMBER_ID")!;
const ACCESS_TOKEN = Deno.env.get("WHATSAPP_ACCESS_TOKEN") || Deno.env.get("META_ACCESS_TOKEN")!;
const APP_SECRET = Deno.env.get("WHATSAPP_APP_SECRET") || Deno.env.get("META_WABA_APP_SECRET")!
